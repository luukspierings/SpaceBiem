...
namespace spacebiem
{
    void ProfileScene::created()
    {
        ...
        addEntity(new SpriteEntity("textures/choose_profile.png", (wW / 2) - 192, wH - 750, Color::White(), -1, -1));
        ...
        if (!p1_resources.empty()) {
            addEntity(new SpriteEntity("textures/resources-hud.png", rX - 40.f, rY - (401.f / scale) / 2.f + 55.f, Color::White(), 401 / scale, 169 / scale, 100u));
            addEntity(new ResourceUIEntity(rX + (rIncr * 0), rY, Color::White(), "uranium", p1_resources["uranium"], font));
            addEntity(new ResourceUIEntity(rX + (rIncr * 1), rY, Color::White(), "diamond", p1_resources["diamond"], font));
            addEntity(new ResourceUIEntity(rX + (rIncr * 2), rY, Color::White(), "metal", p1_resources["metal"], font));
            addEntity(new ResourceUIEntity(rX + (rIncr * 3), rY, Color::White(), "anti-matter", p1_resources["anti-matter"], font));
            ...
            addEntity(new ButtonUIEntity((wW / 2) - (buttonSize.width / 2) - offset, wH - 595, Color{ 135, 25, 25 }, buttonTextColor, buttonDeleteSize, "Delete", buttonLongTexture,
                [this](StateManager* manager)
            {
                FileHandler fh{ "" };
                fh.remove((Player::playerOne().resourceLocation()));
                fh.remove((Player::playerOne().saveLocation()));
                manager->getSceneManager().navigateTo<ProfileScene>();
            }));
        ...
        addEntity(new ButtonUIEntity((wW / 2) - (buttonSize.width / 2) - offset, wH - 650, buttonColor, buttonTextColor, use_size, text, use_texture,
            [this](StateManager* manager)
        {
            Player::current().setName(Player::playerOneName());
            manager->getSceneManager().navigateTo<MenuScene>();
        }));

        rY += 150.f;
        if (!p2_resources.empty()) {
            addEntity(new SpriteEntity("textures/resources-hud.png", rX - 40.f, rY - (401.f / scale) / 2.f + 55.f, Color::White(), 401 / scale, 169 / scale, 100u));
            addEntity(new ResourceUIEntity(rX + (rIncr * 0), rY, Color::White(), "uranium", p2_resources["uranium"], font));
            addEntity(new ResourceUIEntity(rX + (rIncr * 1), rY, Color::White(), "diamond", p2_resources["diamond"], font));
            addEntity(new ResourceUIEntity(rX + (rIncr * 2), rY, Color::White(), "metal", p2_resources["metal"], font));
            addEntity(new ResourceUIEntity(rX + (rIncr * 3), rY, Color::White(), "anti-matter", p2_resources["anti-matter"], font));

            text = "Select 'Mummy'";
            offset = offset_max;

            addEntity(new ButtonUIEntity((wW / 2) - (buttonSize.width / 2) - offset, wH - 445, Color{ 135, 25, 25 }, buttonTextColor, buttonDeleteSize, "Delete", buttonLongTexture,
                [this](StateManager* manager)
            {
                FileHandler fh{ "" };
        ...
        addEntity(new ButtonUIEntity((wW / 2) - (buttonSize.width / 2) - offset, wH - 500, buttonColor, buttonTextColor, use_size, text, use_texture,
            [this](StateManager* manager)
        {
        ...
        if (!p3_resources.empty()) {
            addEntity(new SpriteEntity("textures/resources-hud.png", rX - 40.f, rY - (401.f / scale) / 2.f + 55.f, Color::White(), 401 / scale, 169 / scale, 100u));
            addEntity(new ResourceUIEntity(rX + (rIncr * 0), rY, Color::White(), "uranium", p3_resources["uranium"], font));
            addEntity(new ResourceUIEntity(rX + (rIncr * 1), rY, Color::White(), "diamond", p3_resources["diamond"], font));
            addEntity(new ResourceUIEntity(rX + (rIncr * 2), rY, Color::White(), "metal", p3_resources["metal"], font));
            addEntity(new ResourceUIEntity(rX + (rIncr * 3), rY, Color::White(), "anti-matter", p3_resources["anti-matter"], font));

            text = "Select 'Snowman'";
            offset = offset_max;

            addEntity(new ButtonUIEntity((wW / 2) - (buttonSize.width / 2) - offset, wH - 295, Color{ 135, 25, 25 }, buttonTextColor, buttonDeleteSize, "Delete", buttonLongTexture,
                [this](StateManager* manager)
            {
                FileHandler fh{""};
        ...
        addEntity(new ButtonUIEntity((wW / 2) - (buttonSize.width / 2) - offset, wH - 350, buttonColor, buttonTextColor, use_size, text, use_texture,
            [this](StateManager* manager)
        {
